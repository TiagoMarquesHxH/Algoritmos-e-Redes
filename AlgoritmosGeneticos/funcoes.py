...
def Himmelblau(x,y):
    ...
    função também criará o candidato para a resolução
...
def gene_him():
    ...
    Returns:
        Valor aleatório .float entre 0 e 10
...
def individuo_him(n_genes):
    """ Cria um candidato para a resolução do problema de Himmelblau com dois genes
    
    Args:
        gene: Valor numérico .float aleatório
        
    Returns:
        Candidato à resolver o problema
    """
...
def populacao_him(tamanho, n_genes):
    """ Criação de uma população para o problema de Himmelblau.
    
    Args:
        Tamanho: Quantidade de individuos
        n_genes: Quantidade de genes em cada indivíduo
        
    Returns:
        População contendo a quantidade de individuos e o número de genes de cada um.
